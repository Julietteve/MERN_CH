...
var Archivo = require('./models/File');
var archivo = new Archivo();
var listaProductos = [];
var app = express();
var port = process.env.PORT;
var productPath = '/api/productos';
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                socket.on('new-message', function (data) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, archivo.save(data.author, data.text)];
                            case 1:
                                _d.sent();
...
server.on("error", function (err) { return console.log("Error en el servidor :  " + err); });
